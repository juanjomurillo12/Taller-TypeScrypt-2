...
const seriesTableBody = document.getElementById("tabla_series_body");
...
function renderSeries(series) {
    ...
    document.querySelectorAll(".series-link").forEach(link => {
        link.addEventListener("click", (event) => {
            ...
            const serieId = parseInt(event.currentTarget.getAttribute("data-id"));
            displaySeriesDetails(serieId);
        });
    });
}
function displaySeriesDetails(serieId) {
